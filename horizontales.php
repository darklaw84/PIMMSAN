...
<head>
    ...
    <title>Calderas Horizontales</title>
</head>
...
<body>
    ...
    <img src="horizontales/Horizontalcompleto.svg" class="img-fluid w-100 d-none d-lg-block">

    <img src="galeriaInicio/g3.jpg" class="img-fluid w-100 d-lg-none">
    <img src="horizontales/BannerMovil.svg" class="img-fluid w-100 d-lg-none">


    <a href="contacto.php">
        <img src="horizontales/Cotizar.svg" class='botonCotizar'>
    </a>

    <img src="horizontales/IconosHorizontal.svg" class="img-fluid w-100 d-none d-lg-block">


    <img src="horizontales/IconosMovil.svg" class="img-fluid w-100 d-lg-none">


    <img src="horizontales/CalderasHorizontal.svg" class="img-fluid w-100 d-none d-lg-block">

    <img src="horizontales/CalderasMovil1.svg" class="img-fluid w-100 d-lg-none">
    <div class="row w-100 d-lg-none" style="height: 60px;background-color: #F2F2F2;" align="center">
        <a class="linkCatalogos img-fluid w-100 d-lg-none" target="_blank" href="catalogos/Horizontales.pdf">Descarga Catálogo y Ficha Técnica</a>
    </div>
    <img src="horizontales/CalderasMovil2.svg" class="img-fluid w-100 d-lg-none">
    <div class="row w-100 d-lg-none" style="height: 60px;background-color: #F2F2F2;" align="center">
        <a class="linkCatalogos img-fluid w-100 d-lg-none" target="_blank" href="catalogos/Ficha_Tecnica.pdf">Descarga Catálogo y Ficha Técnica</a>
    </div>



    <img src="horizontales/ConoceHorizontal.svg" class="img-fluid w-100 d-none d-lg-block">


    <img src="horizontales/ConoceMovil.svg" class="img-fluid w-100 d-lg-none">
    ...
    <img src="objetos/gif5.gif" class="gifdoshorizontal">

    <a class="linkCatalogos calderaDryBack d-none d-lg-block" target="_blank" href="catalogos/Horizontales.pdf">Descarga Catálogo y Ficha Técnica</a>

    <a class="linkCatalogos calderaWetBack d-none d-lg-block" target="_blank" href="catalogos/Ficha_Tecnica.pdf">Descarga Catálogo y Ficha Técnica</a>
